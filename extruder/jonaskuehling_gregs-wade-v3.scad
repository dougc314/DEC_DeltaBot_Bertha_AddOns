...
filament_feed_hole_d=2.0;//dec
//filament_diameter=3;
filament_diameter=1.75;//dec
	...
	translate(motor_mount_translation){
		translate([-gear_separation,0,0]){
			...
			rotate(360/16) {
				...
				translate ([0,0,3.5]) cylinder (r1=filament_feed_hole_d*2,r2=filament_feed_hole_d/2,h=filament_feed_hole_d*4); //dec
			}
